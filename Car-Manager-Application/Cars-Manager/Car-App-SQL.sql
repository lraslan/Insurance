...
/*!40103 SET GLOBAL time_zone = '+02:00'*/;
...
--
-- Table structure for table `LIN_info`
--

DROP TABLE IF EXISTS `LIN_info`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `LIN_info` (
  `idLIN_info` int(11) NOT NULL AUTO_INCREMENT,
  `electricity_expenses` varchar(50) DEFAULT NULL,
  `water_expenses` varchar(50) DEFAULT NULL,
  `car_number` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`idLIN_info`),
  UNIQUE KEY `idLIN_info_UNIQUE` (`idLIN_info`)
...
CREATE TABLE `maintenance_info` (
  ...
  `engine_status` varchar(50) DEFAULT NULL,
  `mechanics` varchar(50) DEFAULT NULL,
  `electricity` varchar(50) DEFAULT NULL,
  `plumbings` varchar(50) DEFAULT NULL,
...
CREATE TABLE `revenue_info` (
  ...
  `sales_selling` varchar(50) DEFAULT NULL,
  `insurance_compensation` varchar(50) DEFAULT NULL,
  `accident_compensation` varchar(50) DEFAULT NULL,
  `car_number` varchar(10) DEFAULT NULL,
